...
def get_smart_metadata(ticker_str):
    ...
    try:
        ...
        raw_mer = info.get('expenseRatio') or info.get(
                    ...
                    if len(valid_hist_data) > 1:
                        ...
                        with c2:
                            ...
                            fig_opt.add_trace(go.Bar(
                                x=comp_df["Ticker Symbol"], y=comp_df["Target Weight (%)"], name="Your Target Weight (%)", marker_color="#3b82f6"))
                            fig_opt.add_trace(go.Bar(
                            ...
                            st.plotly_chart(fig_opt.update_layout(barmode='group', template="plotly_dark",
                                            title="Your Target vs AI Optimal Allocations", xaxis_title="", yaxis_title="Weight (%)"), use_container_width=True)
                    else:
                        st.error(
