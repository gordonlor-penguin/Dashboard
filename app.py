...
# --- NEW: MACROECONOMIC DATA ENGINE USING OFFICIAL API ---


@st.cache_data(ttl=86400)  # Cache for 24 hours to save API calls
def get_macro_data():
    api_key = "8420ff9e61cc66f1715e7c6f14ea40c9"
    try:
        ...
        # Fetch Rates (with 10-second timeout)
        ...
        # Fetch CPI (with 10-second timeout)
        ...
        # Filter down to the last 5 years
