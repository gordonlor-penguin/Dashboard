...
def get_macro_data():
    try:
        ...
        rates = web.DataReader('FEDFUNDS', 'fred', start)
        # Pull CPI (Consumer Price Index)
...
with tab5:
    ...
    st.write("Understand the broader economic conditions driving market returns. Data sourced from the Federal Reserve Economic Data (FRED).")
    ...
    if not rates_df.empty and not cpi_df.empty:
        ...
        with col_m2:
            ...
            # Add a target line for the 2% Fed goal
